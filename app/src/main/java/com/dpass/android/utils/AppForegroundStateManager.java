...
public class AppForegroundStateManager {
    ...
    private static final long APP_CLOSED_VALIDATION_TIME_IN_MS = 4 * DateUtils.SECOND_IN_MILLIS; //  4 seconds
    ...
    private void determineAppForegroundState() {
        Logger.d(TAG, "determineAppForegroundState");
        /* 获取当前状态 */
    ...
    private void validateThenNotifyListeners() {
        Logger.d(TAG, "validateThenNotifyListeners");
        ...
        public void handleMessage(Message inputMessage) {
            ...
            switch (inputMessage.what) {
                ...
                case MESSAGE_NOTIFY_LISTENERS:
                    /* 通知所有观察者状态发生了改变 */
                    Logger.d(TAG, "notifyListeners mAppForegroundState " + String.valueOf(mAppForegroundState));
