...
public class PinView extends AppCompatEditText {
    ...
    private static final String TAG = "PinInputView";
    ...
    private int mPinItemBackgroundColor = Color.TRANSPARENT;
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPinItemBackgroundColor = a.getColor(R.styleable.PinView_itemBodyColor, Color.TRANSPARENT);
    ...
    private void drawPinBox(Canvas canvas, int i) {
        ...
        //draw inner color
        mPaint.setColor(mPinItemBackgroundColor);
